                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Modifier reponse</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                    ...
                    <div class="card bg-light" style="height: 100%">
                        <div class="card-header">
                            <div class="card-title row">
                                <div class="col mb-2 mb-md-0">
                                    <h4>Modifier réponse <span class="fas fa-envelope-open-text"></span></h4>
                                </div>
                                <div class="col mb-2 mb-md-0">
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                           <div class="collapse" id="letter-collapse">
                            ...
                            <div class="mt-3">
                                <form action="{{route('answers.update', $answer)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        <div class="text-center">
                                            ...
                                            <input class="form-control" name="title" id="title" placeholder="Titre" value="{{$answer->title ?? old('title')}}">
                                        <textarea class="form-control text-justify" name="content" id="answer" cols="30" rows="40">{{$answer->content ?? old('content')}}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group text-right">
                                        <button type="submit" class="btn btn-primary"><span class="fas fa-send"></span>Enregistrer</button>
                                    </div>
